...
static const char *TAG = "st7801";

esp_err_t esp_lcd_new_panel_st7801(const esp_lcd_panel_io_handle_t io, const esp_lcd_panel_dev_config_t *panel_dev_config,
                                   esp_lcd_panel_handle_t *ret_panel)
{
    ESP_RETURN_ON_FALSE(panel_dev_config && ret_panel, ESP_ERR_INVALID_ARG, TAG, "Invalid arguments");
    st7801_vendor_config_t *vendor_config = NULL;
    if (panel_dev_config->vendor_config) {
        vendor_config = (st7801_vendor_config_t *)panel_dev_config->vendor_config;
    }
    ...
    if (vendor_config && vendor_config->flags.use_mipi_interface) {
        ret = esp_lcd_new_panel_st7801_mipi(io, panel_dev_config, ret_panel);
    ...
    ret = esp_lcd_new_panel_st7801_spi(io, panel_dev_config, ret_panel);
